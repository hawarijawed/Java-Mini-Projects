...
public class Assassin extends Character{
	String profession;
	public Assassin(String type, String name,int health, int life) {
	...
	public void Showappearance() {
		System.out.println("An assassin wearing the customary black clothing, hood, hiding daggers in everything from shoes to sleeves to hair. ");
	}
}
